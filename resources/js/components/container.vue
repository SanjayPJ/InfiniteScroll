<template>
    <div>
        <nav class="navbar is-danger is-primary-gradient is-fixed-top" role="navigation" aria-label="main navigation">
            ...
            <div class="search-span mt-5 display-none">
                <div class="container">
        ...
        <div class="container mt-3">
            <div class="columns is-gapless">
                ...
                <div class="column is-6 ml-3">
                    ...
                    <div class="has-background-white is-radius p-2 mb-3" v-for="post in posts">
                        <article class="media">
                            <div class="media-left">
                                <figure class="image is-48x48">
                                    <img src="logo.jpg" alt="Image" class="is-rounded">
                    ...
                    <div class="observer" id="scrollArea"></div>
                </div>
...
export default {
    ...
    methods: {
        async intersected() {
            const new_posts = await axios.get(`https://jsonplaceholder.typicode.com/posts?_page=${this.page++}`);
            this.posts = [...this.posts, ...new_posts.data];
        }
    },
    mounted() {
